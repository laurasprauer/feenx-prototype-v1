            ...
            <div className="p-6">
              ...
              <div className="flex gap-4 mt-6">
                <div className="flex-1 max-w-[250px]">
                  <Link to="/meal-prep-blueprint" className="block">
                    <div className="flex rounded-lg overflow-hidden hover:scale-105 transition-transform cursor-pointer">
