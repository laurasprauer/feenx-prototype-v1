    ...
    <div className="min-h-screen bg-[#E0F1EB]">
      ...
      <header className="bg-[#1D2F29] w-full h-[58px] flex items-center justify-center">
        ...
        <div className="absolute right-4 flex gap-2">
          <div className="w-8 h-8 bg-[#1D2F29] rounded-full flex items-center justify-center">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
              <path
                d="M7 1.5C4.5 1.5 2.5 3.5 2.5 6V8.5L1.5 9.5V10.5H12.5V9.5L11.5 8.5V6C11.5 3.5 9.5 1.5 7 1.5ZM7 13C7.8 13 8.5 12.3 8.5 11.5H5.5C5.5 12.3 6.2 13 7 13Z"
                fill="white"
              />
            </svg>
          ...
          <div className="w-8 h-8 bg-[#1D2F29] rounded-full flex items-center justify-center">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path d="M6 2L8 4H7V8H9L6 10L3 8H5V4H4L6 2Z" fill="white" />
            </svg>
          </div>
          <div className="w-8 h-8 bg-[#1D2F29] rounded-full flex items-center justify-center">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path
                d="M6 1C8.21 1 10 2.79 10 5C10 7.21 8.21 9 6 9C3.79 9 2 7.21 2 5C2 2.79 3.79 1 6 1ZM6 2.5C4.62 2.5 3.5 3.62 3.5 5C3.5 6.38 4.62 7.5 6 7.5C7.38 7.5 8.5 6.38 8.5 5C8.5 3.62 7.38 2.5 6 2.5Z"
                fill="white"
              />
            </svg>
          </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="relative">
              ...
              <div className="bg-[#CBE3DA] rounded-lg border border-[#1D2F29] shadow-md p-4 mt-8 ml-20">
                ...
                <Button className="bg-[#406057] hover:bg-[#365147] text-white text-xs px-4 py-1 h-auto">
                  <svg
                    width="14"
                    height="13"
                    viewBox="0 0 14 13"
                  ...
                  >
                    <path
                      d="M12.9852 12.6923C12.8941 12.6923 12.8087 12.6752 12.7289 12.6411C12.6492 12.607 12.5751 12.5558 12.5068 12.4876L10.9349 10.9181H4.10059C3.7247 10.9181 3.40292 10.7845 3.13524 10.5172C2.86757 10.2499 2.73373 9.92866 2.73373 9.55335V8.87097H10.2515C10.6274 8.87097 10.9492 8.73734 11.2168 8.47007C11.4845 8.2028 11.6183 7.88151 11.6183 7.5062V2.72953H12.3018C12.6777 2.72953 12.9994 2.86316 13.2671 3.13043C13.5348 3.39769 13.6686 3.71898 13.6686 4.09429V11.9929C13.6686 12.1976 13.6003 12.3653 13.4636 12.4961C13.3269 12.6269 13.1675 12.6923 12.9852 12.6923ZM1.36686 6.94324L2.1699 6.14144H8.88462V1.36476H1.36686V6.94324ZM0.683432 9.2804C0.501183 9.2804 0.341716 9.215 0.20503 9.08421C0.0683432 8.95342 0 8.78567 0 8.58096V1.36476C0 0.989454 0.133839 0.668166 0.401516 0.400899C0.669194 0.133633 0.990976 0 1.36686 0H8.88462C9.2605 0 9.58228 0.133633 9.84996 0.400899C10.1176 0.668166 10.2515 0.989454 10.2515 1.36476V6.14144C10.2515 6.51675 10.1176 6.83804 9.84996 7.1053C9.58228 7.37257 9.2605 7.5062 8.88462 7.5062H2.73373L1.16183 9.07568C1.09349 9.14392 1.01945 9.1951 0.939719 9.22922C0.859985 9.26334 0.774556 9.2804 0.683432 9.2804Z"
                      fill="white"
                    />
                  </svg>
                  Chat with Avery
            ...
            <div className="bg-white rounded-lg border border-[#1D2F29] shadow-sm flex">
              ...
              <div className="flex-1 p-4">
                ...
                <Button className="bg-[#4FA587] hover:bg-[#3F8F77] text-white text-xs px-4 py-1 h-auto">
                  <svg
                    width="14"
                    height="13"
                    viewBox="0 0 14 13"
