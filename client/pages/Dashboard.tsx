              ...
              <div className="p-6 space-y-6 flex-1">
                ...
                <div className="flex items-start gap-3">
                  <div className="w-9 h-9 bg-[#69BCDF] rounded-full flex items-center justify-center">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                      <path
                        d="M12 2C9.24 2 7 4.24 7 7s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0 8c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"
                        fill="white"
                      />
                      <path
                        d="M12 13c-2.33 0-7 1.17-7 3.5v2.5h14v-2.5c0-2.33-4.67-3.5-7-3.5zm-5 4v-0.5c0-.17 2.33-1.5 5-1.5s5 1.33 5 1.5V17H7z"
                        fill="white"
                      />
                      <circle cx="6" cy="12" r="1.5" fill="white" />
                      <circle cx="18" cy="12" r="1.5" fill="white" />
                      <path
                        d="M12 14c0.83 0 1.5 0.67 1.5 1.5s-0.67 1.5-1.5 1.5-1.5-0.67-1.5-1.5 0.67-1.5 1.5-1.5z"
                        fill="white"
                      />
                    </svg>
                  </div>
