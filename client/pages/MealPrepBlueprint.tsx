      ...
      <div className="max-w-[900px] mx-auto px-4 py-6">
        ...
        <div className="flex gap-3 mb-8">
          ...
          <button className="flex items-center gap-2 bg-[#1D2F29] text-white px-4 py-2 rounded-full text-sm font-medium">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path
                d="M12 3C9.79 3 8 4.79 8 7C8 9.21 9.79 11 12 11C14.21 11 16 9.21 16 7C16 4.79 14.21 3 12 3Z"
                fill="white"
              />
              <path
                d="M12 5C10.9 5 10 5.9 10 7C10 8.1 10.9 9 12 9C13.1 9 14 8.1 14 7C14 5.9 13.1 5 12 5Z"
                fill="#1D2F29"
              />
              <path
                d="M12 11C15.31 11 18 13.69 18 17V19C18 19.55 17.55 20 17 20H7C6.45 20 6 19.55 6 19V17C6 13.69 8.69 11 12 11Z"
                fill="white"
              />
              <path d="M5 14L7 15L5 16L4 14.5L5 14Z" fill="white" />
              <path d="M19 14L17 15L19 16L20 14.5L19 14Z" fill="white" />
              <path d="M4 9L6 10L4 11L3 9.5L4 9Z" fill="white" />
              <path d="M20 9L18 10L20 11L21 9.5L20 9Z" fill="white" />
            </svg>
            Select Recipes
          </button>
